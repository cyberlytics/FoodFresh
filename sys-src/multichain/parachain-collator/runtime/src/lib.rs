...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("chainfresh-parachain"),
	impl_name: create_runtime_str!("chainfresh-parachain"),
	authoring_version: 1,
	spec_version: 1,
	impl_version: 0,
...
impl document_registry::Trait for Runtime {
	type Event = Event;
	type CreateRoleOrigin = registrar::EnsureOrg<Runtime>;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
        ...
        DocumentRegistry: document_registry::{Pallet, Call, Storage, Event<T>},
